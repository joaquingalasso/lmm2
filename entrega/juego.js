class Juego {
  ...
  verificarPerdida() {
    if (this.glitch.activo) {
      ...
      if (this.timer === 0) {
        ...
        this.timer = 40; // Establecer un nuevo temporizador para mostrar créditos antes de reiniciar
      }
    }
  }
  ...
  reiniciarJuego() {
    ...
    this.timer = 40; // Reiniciar temporizador de juego
    this.timerCreditos = 40; // Reiniciar temporizador de créditos
